...
const BookingHistoryPage = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#0a0a23] text-white p-8">
      ...
      {bookings.length === 0 ? (
        <p className="text-center text-gray-400">Bạn chưa có lịch sử đặt vé nào.</p>
      ) : (
        <div className="space-y-6 max-w-4xl mx-auto">
          {bookings.map((booking) => (
            ...
            >
              ...
              <div className="mb-2">
                <span className="font-semibold text-yellow-300">Phòng chiếu:</span>{" "}
                {booking.screenName}
              </div>
              <div className="mb-2">
                <span className="font-semibold text-yellow-300">Suất chiếu:</span>{" "}
              ...
              <div className="mb-2">
                <span className="font-semibold text-yellow-300">Ngày đặt:</span>{" "}
                {dayjs(booking.bookingDate).format("DD/MM/YYYY HH:mm")}
              </div>
              <div>
                <span className="font-semibold text-yellow-300">Trạng thái:</span>{" "}
